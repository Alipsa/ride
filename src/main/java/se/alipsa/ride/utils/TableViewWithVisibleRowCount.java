 ...
 *
 * Original author Jeanette Winzenburg, Berlin
 */
public class TableViewWithVisibleRowCount<T> extends TableView<T> {
    ...
    public TableViewWithVisibleRowCount() {}

    public TableViewWithVisibleRowCount(int numberOfRows) {
        visibleRowCount.setValue(numberOfRows);
    }
