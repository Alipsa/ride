...
public class RTextArea extends CodeTextArea {
  ...
  private static final String[] FUNCTIONS = new String[]{
      ...
      "iconv", "identical", "identity", "ifelse", "import", "inherits", "integer", "interaction", "interactive", "is.array", "is.atomic", "is.call", "is.character", "is.complex", "is.data.frame", "is.double", "is.environment", "is.expression", "is.factor", "is.function", "is.integer", "is.language", "is.list", "is.na", "is.null", "is.numeric", "is.matrix", "is.object", "is.ordered", "is.primitive", "is.R", "is.recursive", "is.vector", "isFALSE", "isTRUE", "isIncomplete", "isOpen", "isSymmetric", "I", "ISOdatetime", "ISOdate",
